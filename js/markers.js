...
function attachMarkerToCountry( countryName, importance ){
	...
	if(country.exportedAmount > 0 && country.importedAmount > 0) {
	   importExportText += "entered:" + numberWithCommas(country.importedAmount/1000000) + "<br />" +
	       "left:"+numberWithCommas(country.exportedAmount/1000000);
	} else if(country.exportedAmount > 0 && country.importedAmount == 0) {
	   importExportText += "left:"+numberWithCommas(country.exportedAmount/1000000)+"<br />&nbsp;";
	} else if(country.exportedAmount == 0 && country.importedAmount > 0) {
	   importExportText += "entered:"+numberWithCommas(country.importedAmount/1000000)+"<br />&nbsp;";
	}
